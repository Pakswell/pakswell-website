(function () {
  ...
  var EPAL = {
    ...
    "zh-CN": {
      cardBadge: "实物参考", cardTitle: "下单前确认托盘、生产企业和运输路线", cardCopy: "正式报价会列明型号、生产企业、处理方案、装货港、贸易条款和文件范围。", point3: "40HQ参考<br>600张", point4: "起订量<br>1个整柜", officialVerify: "通过EPAL官方持证企业查询核对所选生产企业 →",
    ...
    "zh-TW": {
      cardBadge: "實物參考", cardTitle: "下單前確認棧板、生產企業與運輸路線", cardCopy: "正式報價會列明型號、生產企業、處理方案、裝貨港、貿易條款與文件範圍。", point3: "40HQ參考<br>600片", point4: "起訂量<br>1個整櫃", officialVerify: "透過EPAL官方持證企業查詢核對所選生產企業 →",
    ...
    th: {
      cardBadge: "ภาพสินค้าจริง", cardTitle: "ยืนยันรุ่น โรงงาน และเส้นทางก่อนออก PO", cardCopy: "ใบเสนอราคาจะระบุรุ่น โรงงาน แผนการอบ ท่าเรือ เงื่อนไขการค้า และขอบเขตเอกสาร", point3: "อ้างอิง 40HQ<br>600 พาเลท", point4: "MOQ<br>1 ตู้ FCL", officialVerify: "ตรวจสอบโรงงานที่เลือกผ่านระบบค้นหาผู้รับใบอนุญาต EPAL →",
    ...
    ko: {
      cardBadge: "실물 제품 참고", cardTitle: "발주 전 팔레트·생산시설·운송경로 확인", cardCopy: "정식 견적서에 모델, 생산시설, 처리계획, 적재항, 거래조건과 서류 범위를 명시합니다.", point3: "40HQ 참고<br>600매", point4: "MOQ<br>1 FCL", officialVerify: "EPAL 공식 라이선스 검색에서 선택한 생산시설 확인 →",
    ...
    ja: {
      cardBadge: "実物製品参考", cardTitle: "発注前にパレット・生産施設・輸送ルートを確認", cardCopy: "正式見積にモデル、生産施設、処理計画、積出港、取引条件、書類範囲を明記します。", point3: "40HQ参考<br>600枚", point4: "MOQ<br>1 FCL", officialVerify: "EPAL公式ライセンシー検索で選定施設を確認 →",
  ...
  function applyEpal(lang) {
    ...
    text(".official-verify a", t.officialVerify);

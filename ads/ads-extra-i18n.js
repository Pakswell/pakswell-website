(function () {
  ...
  var EPAL = {
    en: {
      cardBadge: "Real product reference", cardTitle: "Confirm the pallet, producer and route before PO", cardCopy: "Every quotation identifies the requested model, producing facility, treatment plan, loading port, trade term and document scope.", point3: "MOQ<br>1 × FCL", point4: "Quote target<br>within 24h",
      spec4Key: "Treatment & documents", spec4Value: "ISPM 15 treatment, marking, phytosanitary and commercial document requirements are confirmed for the actual facility, route, and destination.", spec5Key: "Order & shipping", spec5Value: "MOQ usually starts from 1 FCL. Mixed loading can be reviewed. Loading route and EXW, FOB, CIF, DAP or DDP terms are discussed per inquiry.",
    ...
    "zh-CN": {
      cardBadge: "实物参考", cardTitle: "下单前确认托盘、生产企业和运输路线", cardCopy: "正式报价会列明型号、生产企业、处理方案、装货港、贸易条款和文件范围。", point3: "起订量<br>1个整柜", point4: "报价目标<br>24小时内",
      spec4Key: "处理与文件", spec4Value: "ISPM 15处理、标记、植物检疫及商业文件要求，按实际生产企业、路线和目的地确认。", spec5Key: "订单与运输", spec5Value: "通常1个整柜起订，可评估混装；装货路线及EXW、FOB、CIF、DAP或DDP条款按询盘确认。",
    ...
    "zh-TW": {
      cardBadge: "實物參考", cardTitle: "下單前確認棧板、生產企業與運輸路線", cardCopy: "正式報價會列明型號、生產企業、處理方案、裝貨港、貿易條款與文件範圍。", point3: "起訂量<br>1個整櫃", point4: "報價目標<br>24小時內",
      spec4Key: "處理與文件", spec4Value: "ISPM 15處理、標記、植物檢疫及商業文件要求，依實際生產企業、路線與目的地確認。", spec5Key: "訂單與運輸", spec5Value: "通常1個整櫃起訂，可評估混裝；裝貨路線及EXW、FOB、CIF、DAP或DDP條款依詢價確認。",
    ...
    th: {
      cardBadge: "ภาพสินค้าจริง", cardTitle: "ยืนยันรุ่น โรงงาน และเส้นทางก่อนออก PO", cardCopy: "ใบเสนอราคาจะระบุรุ่น โรงงาน แผนการอบ ท่าเรือ เงื่อนไขการค้า และขอบเขตเอกสาร", point3: "MOQ<br>1 ตู้ FCL", point4: "เป้าหมายเสนอราคา<br>ภายใน 24 ชม.",
      spec4Key: "การอบและเอกสาร", spec4Value: "ข้อกำหนด ISPM 15 เครื่องหมาย สุขอนามัยพืช และเอกสารการค้า ยืนยันตามโรงงาน เส้นทาง และปลายทางจริง", spec5Key: "คำสั่งซื้อและขนส่ง", spec5Value: "โดยทั่วไปเริ่มที่ 1 FCL และพิจารณาโหลดรวมได้ เส้นทางและเงื่อนไข EXW, FOB, CIF, DAP หรือ DDP ยืนยันตามคำขอ",
    ...
    vi: {
      cardBadge: "Hình ảnh sản phẩm thực", cardTitle: "Xác nhận pallet, cơ sở và tuyến đường trước PO", cardCopy: "Báo giá chính thức nêu rõ mẫu, cơ sở sản xuất, xử lý, cảng xếp, điều kiện thương mại và chứng từ.", point3: "MOQ<br>1 FCL", point4: "Mục tiêu báo giá<br>trong 24 giờ",
      spec4Key: "Xử lý & chứng từ", spec4Value: "Yêu cầu ISPM 15, dấu, kiểm dịch và chứng từ thương mại được xác nhận theo cơ sở, tuyến đường và điểm đến.", spec5Key: "Đơn hàng & vận chuyển", spec5Value: "MOQ thường từ 1 FCL; có thể xem xét hàng ghép. Tuyến xếp và điều kiện EXW, FOB, CIF, DAP hoặc DDP được xác nhận theo RFQ.",
    ...
    ko: {
      cardBadge: "실물 제품 참고", cardTitle: "발주 전 팔레트·생산시설·운송경로 확인", cardCopy: "정식 견적서에 모델, 생산시설, 처리계획, 적재항, 거래조건과 서류 범위를 명시합니다.", point3: "MOQ<br>1 FCL", point4: "견적 목표<br>24시간 이내",
      spec4Key: "처리 및 서류", spec4Value: "ISPM 15 처리, 마킹, 식물위생 및 상업서류 요건은 실제 시설, 경로와 목적지에 따라 확인합니다.", spec5Key: "주문 및 운송", spec5Value: "MOQ는 보통 1 FCL이며 혼적 검토가 가능합니다. 적재 경로와 EXW, FOB, CIF, DAP, DDP 조건은 문의별로 확인합니다.",
    ...
    ja: {
      cardBadge: "実物製品参考", cardTitle: "発注前にパレット・生産施設・輸送ルートを確認", cardCopy: "正式見積にモデル、生産施設、処理計画、積出港、取引条件、書類範囲を明記します。", point3: "MOQ<br>1 FCL", point4: "見積目標<br>24時間以内",
      spec4Key: "処理・書類", spec4Value: "ISPM 15処理、マーキング、植物検疫、商業書類の要件を実際の施設・ルート・仕向地ごとに確認します。", spec5Key: "注文・輸送", spec5Value: "通常1 FCLから。混載も検討可能です。積載ルートとEXW、FOB、CIF、DAP、DDP条件は案件ごとに確認します。",
  ...
  var COLLAR = {
    en: { badge: "Real warehouse reference", title: "Build the collar set around your pallet and cargo", copy: "Share the footprint, board height, layers per set, quantity, destination and optional accessories.", p1: "1200 × 800<br>standard", p2: "1200 × 1000<br>standard", p3: "600 × 800<br>half pallet", p4: "4 / 6 hinges<br>custom options", spec4Key: "Order basis", spec4Value: "MOQ: 1 x FCL. Mixed loading with pallets, lids, hinges and accessories can be reviewed after the product mix is confirmed.", spec5Key: "Trade terms", spec5Value: "EXW, FOB, CIF, DAP and DDP can be discussed. Loading port, lead time and container quantity are confirmed in the formal quotation." },
    "zh-CN": { badge: "仓库实拍", title: "根据托盘和货物配置整套围板", copy: "请提供托盘尺寸、板高、每套层数、数量、目的地和所需配件。", p1: "1200 × 800<br>标准规格", p2: "1200 × 1000<br>标准规格", p3: "600 × 800<br>半托规格", p4: "4 / 6铰链<br>可定制", spec4Key: "订单基础", spec4Value: "起订量：1个整柜。确认产品组合后，可评估与托盘、盖板、铰链和配件混装。", spec5Key: "贸易条款", spec5Value: "可讨论EXW、FOB、CIF、DAP和DDP；装货港、交期及装柜数量在正式报价中确认。" },
    "zh-TW": { badge: "倉庫實拍", title: "依棧板與貨物配置整套圍板", copy: "請提供棧板尺寸、板高、每套層數、數量、目的地與所需配件。", p1: "1200 × 800<br>標準規格", p2: "1200 × 1000<br>標準規格", p3: "600 × 800<br>半棧板", p4: "4 / 6鉸鏈<br>可客製", spec4Key: "訂單基礎", spec4Value: "起訂量：1個整櫃。確認產品組合後，可評估與棧板、蓋板、鉸鏈及配件混裝。", spec5Key: "貿易條款", spec5Value: "可討論EXW、FOB、CIF、DAP與DDP；裝貨港、交期及裝櫃數量在正式報價中確認。" },
    th: { badge: "ภาพคลังสินค้าจริง", title: "จัดชุดกรอบให้เหมาะกับพาเลทและสินค้า", copy: "แจ้งขนาดพาเลท ความสูง จำนวนชั้น ปริมาณ ปลายทาง และอุปกรณ์เสริม", p1: "1200 × 800<br>มาตรฐาน", p2: "1200 × 1000<br>มาตรฐาน", p3: "600 × 800<br>ครึ่งพาเลท", p4: "4 / 6 บานพับ<br>สั่งทำได้", spec4Key: "เงื่อนไขคำสั่งซื้อ", spec4Value: "MOQ 1 FCL และพิจารณาโหลดร่วมกับพาเลท ฝา บานพับ และอุปกรณ์ได้", spec5Key: "เงื่อนไขการค้า", spec5Value: "รองรับ EXW, FOB, CIF, DAP และ DDP โดยยืนยันท่าเรือ ระยะเวลา และจำนวนในใบเสนอราคา" },
    vi: { badge: "Hình ảnh kho thực tế", title: "Cấu hình bộ collar theo pallet và hàng hóa", copy: "Gửi kích thước pallet, chiều cao ván, số lớp, số lượng, điểm đến và phụ kiện.", p1: "1200 × 800<br>tiêu chuẩn", p2: "1200 × 1000<br>tiêu chuẩn", p3: "600 × 800<br>nửa pallet", p4: "4 / 6 bản lề<br>tùy chỉnh", spec4Key: "Cơ sở đơn hàng", spec4Value: "MOQ 1 FCL; có thể xem xét ghép pallet, nắp, bản lề và phụ kiện.", spec5Key: "Điều kiện thương mại", spec5Value: "Có thể thảo luận EXW, FOB, CIF, DAP và DDP; cảng xếp, lead time và số lượng được xác nhận trong báo giá." },
    ko: { badge: "실제 창고 사진", title: "팔레트와 화물에 맞는 칼라 세트 구성", copy: "팔레트 규격, 보드 높이, 층수, 수량, 목적지와 부속품을 알려주세요.", p1: "1200 × 800<br>표준", p2: "1200 × 1000<br>표준", p3: "600 × 800<br>하프 팔레트", p4: "4 / 6 힌지<br>맞춤 가능", spec4Key: "주문 기준", spec4Value: "MOQ 1 FCL. 팔레트, 뚜껑, 힌지, 부속품 혼적을 검토할 수 있습니다.", spec5Key: "거래 조건", spec5Value: "EXW, FOB, CIF, DAP, DDP를 협의하며 적재항, 납기와 수량은 정식 견적에서 확인합니다." },
    ja: { badge: "実際の倉庫写真", title: "パレットと貨物に合わせてカラーセットを構成", copy: "パレット寸法、板高さ、段数、数量、仕向地、付属品をお知らせください。", p1: "1200 × 800<br>標準", p2: "1200 × 1000<br>標準", p3: "600 × 800<br>ハーフ", p4: "4 / 6ヒンジ<br>カスタム可", spec4Key: "注文条件", spec4Value: "MOQ 1 FCL。パレット、蓋、ヒンジ、付属品との混載を検討できます。", spec5Key: "取引条件", spec5Value: "EXW、FOB、CIF、DAP、DDPを協議し、積出港、納期、数量を正式見積で確認します。" }
  };

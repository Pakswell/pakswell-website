(function () {
  ...
  var EPAL = {
    ...
    "zh-CN": {
      cardBadge: "实物参考", cardTitle: "下单前确认托盘、生产企业和运输路线", cardCopy: "正式报价会列明型号、生产企业、处理方案、装货港、贸易条款和文件范围。", point3: "40HQ参考<br>600 PCS", point4: "起订量<br>1个整柜", officialVerify: "正式报价将列明本订单对应的生产企业及适用许可信息，供采购方核验。",
      spec4Key: "处理与文件", spec4Value: "ISPM 15处理、标记、植物检疫及商业文件要求，按实际生产企业、路线和目的地确认。", spec5Key: "订单与运输", spec5Value: "通常1个整柜起订，可评估混装；装货路线及EXW、FOB、CIF、DAP或DDP条款按询盘确认。", spec6Key: "40HQ参考装载量", spec6Value: "EPAL 1（1200 × 800 mm）：600 PCS。最终数量按包装方式及是否混装确认。",
    ...
    "zh-TW": {
      cardBadge: "實物參考", cardTitle: "下單前確認棧板、生產企業與運輸路線", cardCopy: "正式報價會列明型號、生產企業、處理方案、裝貨港、貿易條款與文件範圍。", point3: "40HQ參考<br>600 PCS", point4: "起訂量<br>1個整櫃", officialVerify: "正式報價將列明本訂單對應的生產企業及適用許可資訊，供採購方核驗。",
      spec4Key: "處理與文件", spec4Value: "ISPM 15處理、標記、植物檢疫及商業文件要求，依實際生產企業、路線與目的地確認。", spec5Key: "訂單與運輸", spec5Value: "通常1個整櫃起訂，可評估混裝；裝貨路線及EXW、FOB、CIF、DAP或DDP條款依詢價確認。", spec6Key: "40HQ參考裝載量", spec6Value: "EPAL 1（1200 × 800 mm）：600 PCS。最終數量依包裝方式及是否混裝確認。",
    ...
    th: {
      cardBadge: "ภาพสินค้าจริง", cardTitle: "ยืนยันรุ่น โรงงาน และเส้นทางก่อนออก PO", cardCopy: "ใบเสนอราคาจะระบุรุ่น โรงงาน แผนการอบ ท่าเรือ เงื่อนไขการค้า และขอบเขตเอกสาร", point3: "อ้างอิง 40HQ<br>600 PCS", point4: "MOQ<br>1 ตู้ FCL", officialVerify: "ใบเสนอราคาอย่างเป็นทางการจะระบุโรงงานผลิตที่ตรงกับคำสั่งซื้อและข้อมูลใบอนุญาตที่เกี่ยวข้อง เพื่อให้ผู้ซื้อใช้ตรวจสอบ",
    ...
    ko: {
      cardBadge: "실물 제품 참고", cardTitle: "발주 전 팔레트·생산시설·운송경로 확인", cardCopy: "정식 견적서에 모델, 생산시설, 처리계획, 적재항, 거래조건과 서류 범위를 명시합니다.", point3: "40HQ 참고<br>600 PCS", point4: "MOQ<br>1 FCL", officialVerify: "정식 견적서에 주문에 해당하는 생산시설과 적용 라이선스 정보를 명시하여 구매자가 확인할 수 있도록 합니다.",
    ...
    ja: {
      cardBadge: "実物製品参考", cardTitle: "発注前にパレット・生産施設・輸送ルートを確認", cardCopy: "正式見積にモデル、生産施設、処理計画、積出港、取引条件、書類範囲を明記します。", point3: "40HQ参考<br>600 PCS", point4: "MOQ<br>1 FCL", officialVerify: "正式見積には、注文に対応する生産施設と適用ライセンス情報を明記し、購入者が確認できるようにします。",

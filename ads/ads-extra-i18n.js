(function () {
  ...
  var EPAL = {
    ...
    "zh-CN": {
      cardBadge: "实物参考", cardTitle: "下单前确认托盘、生产方案和运输路线", cardCopy: "正式报价会列明型号、规格、处理方案、装货港、贸易条款和文件范围。", point3: "40HQ参考<br>600 PCS", point4: "起订量<br>1个整柜", officialVerify: "正式报价将列明适用生产许可、处理和文件信息，供采购方核验。",
      ...
      faqs: [["可以从中国采购EPAL托盘吗？", "可以。PAKSWELL在中国生产EPAL 1和EPAL 3托盘，服务整柜出口订单。"], ["可以提供处理文件吗？", "处理、标记、植物检疫和商业文件按订单、路线及目的地确认。"], ["报价需要哪些信息？", "请提供EPAL型号、尺寸、数量、目的港和交付时间。"], ["托盘可以与围板箱混装吗？", "可以。确认产品组合和装柜方案后评估混装。"]]
    },
    "zh-TW": {
      cardBadge: "實物參考", cardTitle: "下單前確認棧板、生產計畫與運輸路線", cardCopy: "正式報價會列明型號、規格、處理方案、裝貨港、貿易條款與文件範圍。", point3: "40HQ參考<br>600 PCS", point4: "起訂量<br>1個整櫃", officialVerify: "正式報價將列明適用生產許可、處理及文件資訊，供採購方核驗。",
      ...
      faqs: [["可以從中國採購EPAL棧板嗎？", "可以。PAKSWELL在中國生產EPAL 1與EPAL 3棧板，服務整櫃出口訂單。"], ["可以提供處理文件嗎？", "處理、標記、植物檢疫與商業文件依訂單、路線及目的地確認。"], ["報價需要哪些資訊？", "請提供EPAL型號、尺寸、數量、目的港與交付時間。"], ["棧板可以與圍板箱混裝嗎？", "可以。確認產品組合與裝櫃方案後評估混裝。"]]
    },
    th: {
      cardBadge: "ภาพสินค้าจริง", cardTitle: "ยืนยันรุ่น แผนการผลิต และเส้นทางก่อนออก PO", cardCopy: "ใบเสนอราคาจะระบุรุ่น ข้อกำหนด แผนการอบ ท่าเรือ เงื่อนไขการค้า และขอบเขตเอกสาร", point3: "อ้างอิง 40HQ<br>600 PCS", point4: "MOQ<br>1 ตู้ FCL", officialVerify: "ใบเสนอราคาอย่างเป็นทางการจะระบุใบอนุญาตการผลิต การอบ และรายละเอียดเอกสารที่เกี่ยวข้องเพื่อให้ผู้ซื้อใช้ตรวจสอบ",
    ...
    ko: {
      cardBadge: "실물 제품 참고", cardTitle: "발주 전 팔레트·생산계획·운송경로 확인", cardCopy: "정식 견적서에 모델, 규격, 처리계획, 적재항, 거래조건과 서류 범위를 명시합니다.", point3: "40HQ 참고<br>600 PCS", point4: "MOQ<br>1 FCL", officialVerify: "정식 견적서에 적용 생산 라이선스, 처리 및 서류 정보를 명시하여 구매자가 확인할 수 있도록 합니다.",
    ...
    ja: {
      cardBadge: "実物製品参考", cardTitle: "発注前にパレット・生産計画・輸送ルートを確認", cardCopy: "正式見積にモデル、仕様、処理計画、積出港、取引条件、書類範囲を明記します。", point3: "40HQ参考<br>600 PCS", point4: "MOQ<br>1 FCL", officialVerify: "正式見積には、適用される生産ライセンス、処理、書類情報を明記し、購入者が確認できるようにします。",
      ...
      faqs: [["中国からEPALパレットを購入できますか？", "はい。PAKSWELLは中国でFCL注文向けEPAL 1とEPAL 3パレットを製造します。"], ["処理書類はありますか？", "処理、マーキング、植物検疫、商業書類を注文ごとに確認します。"], ["見積に必要な情報は？", "モデル、寸法、数量、到着港、納期をお知らせください。"], ["パレットカラーと混載できますか？", "はい。製品構成と積載計画の確認後に検討します。"]]
    }
  };

  var COLLAR = {
    en: { badge: "Real warehouse reference", title: "Build the collar set around your pallet and cargo", copy: "Share the footprint, board height, layers per set, quantity, destination and optional accessories.", p1: "1200 × 800<br>standard", p2: "1200 × 1000<br>standard", p3: "600 × 800<br>half pallet", p4: "4 / 6 hinges<br>custom options", spec4Key: "Order basis", spec4Value: "MOQ: 1 x FCL. Mixed loading with pallets, lids, hinges and accessories can be reviewed after the product mix is confirmed.", spec5Key: "Trade terms", spec5Value: "EXW, FOB, CIF, DAP and DDP can be discussed. Loading port, lead time and container quantity are confirmed in the formal quotation.", spec6Key: "40HQ loading reference", spec6Value: "1200 × 800 mm pallet collars: 2,714 PCS. Final quantity is confirmed against the packing method and order mix." },
    "zh-CN": { badge: "仓库实拍", title: "根据托盘和货物配置整套围板", copy: "请提供托盘尺寸、板高、每套层数、数量、目的地和所需配件。", p1: "1200 × 800<br>标准规格", p2: "1200 × 1000<br>标准规格", p3: "600 × 800<br>半托规格", p4: "4 / 6铰链<br>可定制", spec4Key: "订单基础", spec4Value: "起订量：1个整柜。确认产品组合后，可评估与托盘、盖板、铰链和配件混装。", spec5Key: "贸易条款", spec5Value: "可讨论EXW、FOB、CIF、DAP和DDP；装货港、交期及装柜数量在正式报价中确认。", spec6Key: "40HQ参考装载量", spec6Value: "1200 × 800 mm围板：2,714 PCS。最终数量按包装方式及是否混装确认。" },

  ...
  var PRODUCT_COPY = {
    ...
    "pallet-collars": {
      en: {
        ...
        heroTitle: "European Standard Wooden Pallet Collar Packaging for EU Exports, Meeting EU PPWR Requirements",
        ...
        spec2Key: "Structure",
        spec2Value: "Foldable solid wood boards with galvanized hinges. Plywood lids and plastic corners optional.",
        spec3Key: "MOQ",
      ...
      th: {
        ...
        heroTitle: "บรรจุภัณฑ์กรอบพาเลทไม้มาตรฐานยุโรปสำหรับส่งออกไปสหภาพยุโรป สอดคล้องข้อกำหนด PPWR ของสหภาพยุโรป",
        heroCopy: "กล่องกรอบพาเลทมาตรฐานยุโรปประกอบง่าย พับได้ ช่วยประหยัดพื้นที่และต้นทุนขนส่ง เหมาะเป็นบรรจุภัณฑ์ไม้มาตรฐานสำหรับส่งออกไปยุโรป และสอดคล้องข้อกำหนด PPWR และ EUDR ของสหภาพยุโรป",
      ...
      "zh-CN": {
        ...
        heroTitle: "适合出口欧盟的欧洲标准木围板包装 符合欧盟PPWR要求",
        heroCopy: "欧洲标准围板箱组装简单，可折叠，运输节省空间和成本，适合出口到欧洲的标准木包装。符合欧盟PPWR和EUDR要求。",
        heroQuote: "获取围板箱报价",
        fact1: "月产 100K+ 围板",
        fact2: "起订量：1个集装箱",
        fact3: "标准与定制尺寸",
      ...
      "zh-TW": {
        ...
        heroTitle: "適合出口歐盟的歐洲標準木圍板包裝 符合歐盟PPWR要求",
        heroCopy: "歐洲標準圍板箱組裝簡單，可折疊，運輸節省空間和成本，適合出口到歐洲的標準木包裝。符合歐盟PPWR和EUDR要求。",
        heroQuote: "取得圍板箱報價",
        fact1: "月產 100K+ 圍板",
        fact2: "起訂量：1個貨櫃",
        fact3: "標準與客製尺寸",
      ...
      vi: {
        ...
        heroTitle: "Bao bì pallet collar gỗ tiêu chuẩn châu Âu cho xuất khẩu EU, đáp ứng yêu cầu PPWR của EU",
        heroCopy: "Thùng pallet collar tiêu chuẩn châu Âu dễ lắp ráp, có thể gấp gọn, giúp tiết kiệm không gian và chi phí vận chuyển. Phù hợp làm bao bì gỗ tiêu chuẩn xuất khẩu sang châu Âu và đáp ứng yêu cầu PPWR, EUDR của EU.",
      ...
      ko: {
        ...
        heroTitle: "EU 수출용 유럽 표준 목재 팔레트 칼라 포장, EU PPWR 요건 충족",
        heroCopy: "유럽 표준 팔레트 칼라 박스는 조립이 쉽고 접을 수 있어 운송 공간과 비용을 절감합니다. 유럽 수출용 표준 목재 포장에 적합하며 EU PPWR 및 EUDR 요건을 충족합니다.",
      ...
      ja: {
        ...
        heroTitle: "EU輸出向け欧州標準木製パレットカラー梱包 EU PPWR要件に対応",
        heroCopy: "欧州標準のパレットカラー箱は組み立てが簡単で折りたたみ可能なため、輸送スペースとコストを削減できます。欧州向け輸出の標準木製梱包に適しており、EU PPWRおよびEUDR要件に対応しています。",

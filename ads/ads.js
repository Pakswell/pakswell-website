(function () {
  ...
  var PRODUCT_COPY = {
    "epal-euro-pallets": {
      ...
      th: {
        ...
        metaDescription: "พาเลท EPAL Euro จากจีนสำหรับผู้นำเข้าแบบ FCL ได้รับสิทธิ์ EPAL ผ่าน ISPM 15 มีไซซ์มาตรฐานพร้อมส่ง และเสนอราคาใน 24 ชม.",
        ogTitle: "พาเลท EPAL Euro จากจีน | PAKSWELL",
        ogDescription: "พาเลท EPAL ถูกลิขสิทธิ์ ผ่าน ISPM 15 พร้อมเอกสารส่งออกจากจีน",
        eyebrow: "ผลิตตามสิทธิ์ EPAL | ISPM 15 HT",
        ...
        specsLead: "พาเลท Euro ที่ได้รับสิทธิ์ EPAL ผลิตในจีน มีไซซ์มาตรฐานตลอดปี ส่งออกแบบ FCL พร้อมเอกสารครบถ้วน เมื่อยืนยันปลายทาง จำนวน และรุ่น ส่วนใหญ่เสนอราคาได้ภายใน 24 ชั่วโมง",
        spec1Key: "ขนาด",
        spec1Value: "1200 x 800 มม. EPAL 1, 1200 x 1000 มม. EPAL 3 และรุ่นที่ได้รับอนุญาตอื่นตามสอบถาม",
        spec2Key: "การอบ/เอกสาร",
        spec2Value: "อบร้อน ISPM 15 พร้อม phytosanitary certificate และเอกสารส่งออกครบทุก shipment",
        spec3Key: "MOQ",
      ...
      "zh-CN": {
        ...
        metaDescription: "中国生产 EPAL 欧标托盘，适合整柜出口买家。EPAL 授权，ISPM 15 热处理，标准尺寸常备库存，24小时内报价。",
        ogTitle: "中国 EPAL 欧标托盘 | PAKSWELL",
        ogDescription: "EPAL 授权托盘，ISPM 15 热处理，中国整柜出口。",
        eyebrow: "EPAL 授权生产 | ISPM 15 热处理",
        ...
        specsLead: "中国制造的 EPAL 授权欧标托盘，标准尺寸全年备货，整柜出口并提供完整文件。确认目的港、数量和型号后，大多数报价可在24小时内发出。",
        spec1Key: "尺寸",
        spec1Value: "1200 x 800 mm EPAL 1、1200 x 1000 mm EPAL 3，以及可询价的其他授权型号。",
        spec2Key: "处理",
      ...
      "zh-TW": {
        ...
        metaDescription: "中國生產 EPAL 歐標棧板，適合整櫃出口買家。EPAL 授權，ISPM 15 熱處理，標準尺寸常備庫存，24小時內報價。",
        ogTitle: "中國 EPAL 歐標棧板 | PAKSWELL",
        ogDescription: "EPAL 授權棧板，ISPM 15 熱處理，中國整櫃出口。",
        eyebrow: "EPAL 授權生產 | ISPM 15 熱處理",
        ...
        specsLead: "中國製造的 EPAL 授權歐標棧板，標準尺寸全年備貨，整櫃出口並提供完整文件。確認目的港、數量和型號後，多數報價可在24小時內提供。",
        spec1Key: "尺寸",
        spec1Value: "1200 x 800 mm EPAL 1、1200 x 1000 mm EPAL 3，以及可詢價的其他授權型號。",
        spec2Key: "處理",
      ...
      vi: {
        ...
        metaDescription: "Pallet EPAL Euro từ Trung Quốc cho người mua FCL. Được cấp phép EPAL, xử lý nhiệt ISPM 15, kích thước chuẩn luôn có hàng, báo giá trong 24 giờ.",
        ogTitle: "Pallet EPAL Euro từ Trung Quốc | PAKSWELL",
        ogDescription: "Pallet EPAL được cấp phép, xử lý nhiệt ISPM 15, xuất khẩu FCL từ Trung Quốc.",
        eyebrow: "Sản xuất được cấp phép EPAL | ISPM 15 HT",
        ...
        specsLead: "Pallet Euro được cấp phép EPAL sản xuất tại Trung Quốc, có kích thước chuẩn quanh năm và xuất FCL với đầy đủ chứng từ. Phần lớn báo giá được gửi trong 24 giờ sau khi xác nhận cảng đến, số lượng và model.",
        spec1Key: "Kích thước",
        spec1Value: "1200 x 800 mm EPAL 1, 1200 x 1000 mm EPAL 3, và các model được cấp phép khác theo yêu cầu.",
        spec2Key: "Xử lý",
      ...
      ko: {
        ...
        metaDescription: "FCL 수입 바이어를 위한 중국산 EPAL 유로 팔레트. EPAL 라이선스, ISPM 15 열처리, 표준 사이즈 재고, 24시간 내 견적.",
        ogTitle: "중국산 EPAL 유로 팔레트 | PAKSWELL",
        ogDescription: "EPAL 라이선스 팔레트, ISPM 15 열처리, 중국 FCL 수출.",
        eyebrow: "EPAL 라이선스 생산 | ISPM 15 HT",
        ...
        specsLead: "중국에서 제조되는 EPAL 라이선스 유로 팔레트로, 표준 사이즈를 연중 보유하고 FCL로 완전한 수출 서류와 함께 선적합니다. 도착 항구, 수량, 모델 확인 후 대부분 24시간 내 견적을 제공합니다.",
        spec1Key: "사이즈",
      ...
      ja: {
        ...
        metaDescription: "FCL 輸入バイヤー向け中国製 EPAL ユーロパレット。EPAL 認定、ISPM 15 熱処理、標準サイズ在庫、24時間以内に見積。",
        ogTitle: "中国製 EPAL ユーロパレット | PAKSWELL",
        ogDescription: "EPAL 認定パレット、ISPM 15 熱処理、中国から FCL 輸出。",
        eyebrow: "EPAL 認定生産 | ISPM 15 HT",
        ...
        specsLead: "中国で製造される EPAL 認定ユーロパレット。標準サイズを通年在庫し、完全な輸出書類付きで FCL 出荷します。到着港、数量、モデル確認後、多くは24時間以内に見積を提出します。",
        spec1Key: "サイズ",
    ...
    "pallet-collars": {
      en: {
        ...
        heroTitle: "Solid Wood Pallet Collars for Export Packaging and Returnable Storage",
        heroCopy: "Foldable solid wood pallet collars that turn standard pallets into modular containers. Built for FCL export buyers who need efficient packing, reliable hinges, plywood lids, and flexible size options.",
        ...
        specsLabel: "Product fit",
        specsTitle: "For packaging buyers replacing crates and one-way boxes",
        specsLead: "Foldable solid wood pallet collars built for export buyers who need modular sidewalls in place of one-way crates. Standard sizes are stocked year-round; custom dimensions and plywood lids available on request.",
        spec1Key: "Sizes",
        spec1Value: "1200 x 800 mm, 1200 x 1000 mm, 600 x 800 mm, plus custom dimensions on request.",
        spec2Key: "Structure",
        spec2Value: "Foldable solid wood boards with galvanized hinges. Plywood lids and stacking corners optional.",
        spec3Key: "MOQ",
        spec3Value: "1 x FCL. Mixed loading with pallets, lids, and accessories on request.",
        processLabel: "Buying process",
        ...
        step2Copy: "Hinge option, lids, corners, mixed loading.",
        ...
        quoteLead: "For the fastest quote, include pallet footprint, collar height, layers per set, quantity, destination port, and whether you need lids or corners.",
        emailCta: "Email Directly",
        ...
        formMessagePlaceholder: "Size (1200x800 / 1200x1000 / 600x800 / custom), board height, lids, corners, branding, or anything else we should know.",
      ...
      th: {
        ...
        heroTitle: "กรอบพาเลทไม้สำหรับบรรจุภัณฑ์ส่งออกและจัดเก็บหมุนเวียน",
        heroCopy: "กรอบพาเลทไม้พับได้ที่เปลี่ยนพาเลทมาตรฐานให้เป็นกล่องโมดูลาร์ เหมาะสำหรับผู้ซื้อ FCL ที่ต้องการบรรจุภัณฑ์มีประสิทธิภาพ บานพับทนทาน ฝาไม้อัด และตัวเลือกขนาดยืดหยุ่น",
        ...
        specsLabel: "เหมาะสำหรับ",
        specsTitle: "สำหรับผู้ซื้อที่ต้องการแทนลังไม้และกล่องใช้ครั้งเดียว",
        specsLead: "กรอบพาเลทไม้พับได้สำหรับผู้ซื้อส่งออกที่ต้องการผนังข้างแบบโมดูลาร์แทนลังใช้ครั้งเดียว มีขนาดมาตรฐานพร้อมสต็อกตลอดปี และรองรับขนาดสั่งทำพร้อมฝาไม้อัด",
        spec1Key: "ขนาด",
        spec1Value: "1200 x 800 มม., 1200 x 1000 มม., 600 x 800 มม. และขนาดสั่งทำ",
        spec2Key: "โครงสร้าง",
        spec2Value: "แผ่นไม้จริงพับได้พร้อมบานพับชุบกัลวาไนซ์ เลือกฝาไม้อัดและมุมซ้อนได้",
        spec3Key: "MOQ",
        ...
        step2Copy: "บานพับ ฝา มุม และการโหลดร่วม",
        ...
        quoteLead: "เพื่อเสนอราคาเร็ว โปรดระบุขนาดฐานพาเลท ความสูงกรอบ จำนวนชั้นต่อชุด จำนวน ท่าเรือ และต้องการฝาหรือมุมหรือไม่",
        emailCta: "ส่งอีเมลโดยตรง",
        emailSubject: "Pallet Collar Quote Request",
        formDestinationPlaceholder: "Laem Chabang, Cat Lai, Busan...",
        formQuantityPlaceholder: "ชุด ชิ้น หรือตู้คอนเทนเนอร์",
        formMessagePlaceholder: "ขนาด (1200x800 / 1200x1000 / 600x800 / สั่งทำ), ความสูงแผ่น, ฝา, มุม, โลโก้ หรือข้อกำหนดอื่น",
      ...
      "zh-CN": {
        ...
        heroTitle: "用于出口包装和循环仓储的实木围板箱",
        heroCopy: "可折叠实木围板箱可把标准托盘变成模块化箱体，适合需要高效包装、可靠铰链、胶合板盖和灵活尺寸的整柜出口买家。",
        heroQuote: "获取围板箱报价",
        fact1: "月产 100K+ 围板",
        fact2: "起订量：1个集装箱",
        fact3: "标准与定制尺寸",
        fact4: "可折平，适合返程物流",
        specsLabel: "产品匹配",
        specsTitle: "适合想替代木箱和一次性纸箱的包装买家",
        specsLead: "可折叠实木围板箱适合需要模块化侧板、替代一次性木箱的出口买家。标准尺寸全年备货，可按需定制尺寸并提供胶合板盖。",
        spec1Key: "尺寸",
        spec1Value: "1200 x 800 mm、1200 x 1000 mm、600 x 800 mm，也可按需定制。",
        spec2Key: "结构",
        spec2Value: "可折叠实木板搭配镀锌铰链，可选胶合板盖和堆叠角。",
        spec3Key: "起订量",
        ...
        quoteLead: "为了更快报价，请提供托盘尺寸、围板高度、每套层数、数量、目的港，以及是否需要盖板或堆叠角。",
        emailCta: "直接发送邮件",
        emailSubject: "Pallet Collar Quote Request",
        formDestinationPlaceholder: "林查班、吉莱、釜山...",
        formQuantityPlaceholder: "套数、件数或集装箱数量",
        formMessagePlaceholder: "尺寸（1200x800 / 1200x1000 / 600x800 / 定制）、板高、盖板、堆叠角、品牌标识或其他要求。",
        formSubmit: "发送围板箱询价"
      },
      "zh-TW": {
        ...
        heroTitle: "用於出口包裝與循環倉儲的實木圍板箱",
        heroCopy: "可折疊實木圍板箱可把標準棧板變成模組化箱體，適合需要高效包裝、可靠鉸鏈、膠合板蓋和彈性尺寸的整櫃出口買家。",
        heroQuote: "取得圍板箱報價",
        fact1: "月產 100K+ 圍板",
        fact2: "起訂量：1個貨櫃",
        fact3: "標準與客製尺寸",
        fact4: "可折平，適合返程物流",
        specsLabel: "產品適配",
        specsTitle: "適合想替代木箱和一次性紙箱的包裝買家",
        specsLead: "可折疊實木圍板箱適合需要模組化側板、替代一次性木箱的出口買家。標準尺寸全年備貨，可按需客製尺寸並提供膠合板蓋。",
        spec1Key: "尺寸",
        spec1Value: "1200 x 800 mm、1200 x 1000 mm、600 x 800 mm，也可按需客製。",
        spec2Key: "結構",
        spec2Value: "可折疊實木板搭配鍍鋅鉸鏈，可選膠合板蓋和堆疊角。",
        spec3Key: "起訂量",
        ...
        quoteLead: "為了更快報價，請提供棧板尺寸、圍板高度、每套層數、數量、目的港，以及是否需要蓋板或堆疊角。",
        emailCta: "直接寄送郵件",
        emailSubject: "Pallet Collar Quote Request",
        formDestinationPlaceholder: "林查班、吉萊、釜山...",
        formQuantityPlaceholder: "套數、件數或貨櫃數量",
        formMessagePlaceholder: "尺寸（1200x800 / 1200x1000 / 600x800 / 客製）、板高、蓋板、堆疊角、品牌標示或其他需求。",
        formSubmit: "送出圍板箱詢價"
      },
      vi: {
        ...
        heroTitle: "Pallet Collars gỗ cho bao bì xuất khẩu và lưu kho hoàn hồi",
        heroCopy: "Pallet collar gỗ gấp gọn biến pallet tiêu chuẩn thành thùng module. Phù hợp người mua FCL cần đóng gói hiệu quả, bản lề bền, nắp plywood và nhiều tùy chọn kích thước.",
        ...
        specsLabel: "Phù hợp sản phẩm",
        specsTitle: "Cho người mua muốn thay thế thùng gỗ và hộp dùng một lần",
        specsLead: "Pallet collar gỗ gấp gọn dành cho người mua xuất khẩu cần thành bên module thay cho thùng dùng một lần. Kích thước chuẩn có hàng quanh năm; kích thước tùy chỉnh và nắp plywood theo yêu cầu.",
        spec1Key: "Kích thước",
        spec1Value: "1200 x 800 mm, 1200 x 1000 mm, 600 x 800 mm, và kích thước tùy chỉnh.",
        spec2Key: "Kết cấu",
        spec2Value: "Ván gỗ đặc gấp gọn với bản lề mạ kẽm. Tùy chọn nắp plywood và góc xếp chồng.",
        spec3Key: "MOQ",
        ...
        step2Copy: "Bản lề, nắp, góc, đóng chung container.",
        ...
        quoteLead: "Để báo giá nhanh, hãy gửi footprint pallet, chiều cao collar, số lớp mỗi bộ, số lượng, cảng đến và nhu cầu nắp/góc.",
        emailCta: "Gửi email trực tiếp",
        emailSubject: "Pallet Collar Quote Request",
        formDestinationPlaceholder: "Laem Chabang, Cat Lai, Busan...",
        formQuantityPlaceholder: "Bộ, chiếc hoặc container",
        formMessagePlaceholder: "Kích thước (1200x800 / 1200x1000 / 600x800 / tùy chỉnh), chiều cao ván, nắp, góc, logo hoặc yêu cầu khác.",
      ...
      ko: {
        ...
        heroTitle: "수출 포장과 회수 보관을 위한 목재 팔레트 칼라",
        heroCopy: "표준 팔레트를 모듈형 컨테이너로 바꾸는 접이식 목재 팔레트 칼라입니다. 효율적인 포장, 견고한 힌지, 합판 뚜껑, 다양한 사이즈가 필요한 FCL 바이어에게 적합합니다.",
        ...
        fact4: "회수 물류용 평면 접이식",
        specsLabel: "제품 적합성",
        specsTitle: "목상자와 일회용 박스를 대체하려는 포장 바이어용",
        specsLead: "일회용 크레이트 대신 모듈형 측벽이 필요한 수출 바이어를 위한 접이식 목재 팔레트 칼라입니다. 표준 사이즈는 연중 재고가 있으며 맞춤 치수와 합판 뚜껑도 가능합니다.",
        spec1Key: "사이즈",
        spec1Value: "1200 x 800 mm, 1200 x 1000 mm, 600 x 800 mm 및 맞춤 치수.",
        spec2Key: "구조",
        spec2Value: "아연도금 힌지가 있는 접이식 원목 보드. 합판 뚜껑과 적층 코너 선택 가능.",
        spec3Key: "MOQ",
        ...
        quoteLead: "빠른 견적을 위해 팔레트 footprint, 칼라 높이, 세트당 층수, 수량, 도착 항구, 뚜껑/코너 필요 여부를 알려주세요.",
        emailCta: "이메일 보내기",
        emailSubject: "Pallet Collar Quote Request",
        formDestinationPlaceholder: "Laem Chabang, Cat Lai, Busan...",
        formQuantityPlaceholder: "세트, 개수 또는 컨테이너",
        formMessagePlaceholder: "사이즈(1200x800 / 1200x1000 / 600x800 / 맞춤), 보드 높이, 뚜껑, 코너, 브랜딩 또는 기타 요구사항.",
      ...
      ja: {
        ...
        heroTitle: "輸出梱包と返送保管向け木製パレットカラー",
        heroCopy: "標準パレットをモジュール式コンテナに変える折りたたみ木製パレットカラー。効率的な梱包、信頼性の高いヒンジ、合板蓋、柔軟なサイズを求める FCL バイヤー向けです。",
        ...
        fact4: "返送物流向けに平折り",
        specsLabel: "製品適合",
        specsTitle: "木箱や使い捨て箱を置き換えたい梱包バイヤー向け",
        specsLead: "一方向木箱の代わりにモジュール式側板を必要とする輸出バイヤー向けの折りたたみ木製パレットカラー。標準サイズは通年在庫し、カスタム寸法と合板蓋も対応可能です。",
        spec1Key: "サイズ",
        spec1Value: "1200 x 800 mm、1200 x 1000 mm、600 x 800 mm、カスタム寸法対応。",
        spec2Key: "構造",
        spec2Value: "亜鉛メッキヒンジ付き折りたたみ無垢材ボード。合板蓋と積み重ねコーナーはオプション。",
        spec3Key: "MOQ",
        ...
        quoteLead: "迅速な見積のため、パレット寸法、カラー高さ、1セットの段数、数量、到着港、蓋やコーナーの要否をお知らせください。",
        emailCta: "直接メール",
        emailSubject: "Pallet Collar Quote Request",
        formDestinationPlaceholder: "Laem Chabang, Cat Lai, Busan...",
        formQuantityPlaceholder: "セット、個数、またはコンテナ数",
        formMessagePlaceholder: "サイズ（1200x800 / 1200x1000 / 600x800 / カスタム）、板高さ、蓋、コーナー、ロゴ、その他要件。",
    ...
    "pallet-collar-hinges": {
      en: {
        ...
        heroCopy: "A focused landing page for buyers sourcing pallet collar hinges, hinge hardware, or custom stamped galvanized parts for foldable wooden packaging.",
        ...
        specsLabel: "Product fit",
        specsTitle: "For pallet collar factories and hardware buyers",
      ...
      th: {
        ...
        specsLabel: "เหมาะสำหรับ",
        specsTitle: "สำหรับโรงงานกรอบพาเลทและผู้ซื้อฮาร์ดแวร์",
      ...
      vi: {
        ...
        specsLabel: "Phù hợp sản phẩm",
        specsTitle: "Cho nhà máy pallet collar và người mua phần cứng",
      ...
      ko: {
        ...
        fact4: "팔레트 칼라 공장용",
        specsLabel: "제품 적합성",
        specsTitle: "팔레트 칼라 공장과 하드웨어 바이어용",
  ...
  function applyAdsLanguage(lang, options) {
    ...
    setText(".nav-links a:nth-child(3)", t.navSpecs);
    setText(".nav-links a:nth-child(4)", t.navProcess);

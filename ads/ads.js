(function () {
  ...
  var PRODUCT_COPY = {
    "epal-euro-pallets": {
      en: {
        metaTitle: "EPAL Pallet Manufacturer in China | FCL Export | PAKSWELL",
        metaDescription: "PAKSWELL manufactures EPAL 1 and EPAL 3 pallets in China for FCL export buyers, with ISPM 15 heat treatment, quality control, loading photos, and export documents.",
        ogTitle: "EPAL Pallet Manufacturer in China | PAKSWELL",
        ogDescription: "EPAL 1 and EPAL 3 pallet manufacturing in China for FCL export, with ISPM 15 heat treatment, quality control, and loading documentation.",
        eyebrow: "EPAL pallet China manufacturer | ISPM 15 HT",
        heroTitle: "EPAL Pallet Manufacturer in China for FCL Export",
        heroCopy: "PAKSWELL manufactures EPAL 1 and EPAL 3 pallets in China for importers who require consistent production, ISPM 15 heat treatment, quality control, supervised loading, and clear export documents.",
        ...
        specsLead: "PAKSWELL manufactures EPAL pallets for FCL buyers who need consistent specifications, ISPM 15 heat treatment, quality control, a clear loading route, and complete destination documents.",
        ...
        spec3Key: "Quality & compliance",
        spec3Value: "Applicable EPAL licence details, treatment markings, and export document scope are confirmed in the formal quotation before purchase order approval.",
      ...
      th: {
        ...
        metaDescription: "PAKSWELL ผลิตพาเลท EPAL 1 และ EPAL 3 ในประเทศจีนสำหรับผู้ซื้อ FCL พร้อมการอบร้อน ISPM 15 การควบคุมคุณภาพ และเอกสารส่งออก",
        ogTitle: "พาเลท EPAL Euro จากจีน | PAKSWELL",
        ogDescription: "ผู้ผลิตพาเลท EPAL ในจีนสำหรับ FCL พร้อมการอบร้อน การควบคุมคุณภาพ และเอกสารส่งออก",
        eyebrow: "ผู้ผลิตพาเลท EPAL ในจีน | ISPM 15 HT",
        heroTitle: "ผู้ผลิตพาเลท EPAL Euro ในจีนสำหรับส่งออกแบบ FCL",
        heroCopy: "PAKSWELL ผลิตพาเลท EPAL 1 และ EPAL 3 ในประเทศจีน พร้อมการอบร้อน ISPM 15 การควบคุมคุณภาพ การโหลดตู้ และเอกสารส่งออกที่ชัดเจน",
        ...
        specsLead: "PAKSWELL ผลิตพาเลท EPAL สำหรับผู้ซื้อ FCL โดยยืนยันรุ่น แผนการผลิต การอบร้อน การควบคุมคุณภาพ เส้นทางขนส่ง และเอกสารก่อนออกใบสั่งซื้อ",
        spec1Key: "ขนาด",
      ...
      "zh-CN": {
        ...
        metaDescription: "PAKSWELL在中国生产EPAL 1和EPAL 3欧标托盘，为整柜买家提供ISPM 15热处理、质量控制、装柜及出口文件。",
        ogTitle: "中国 EPAL 欧标托盘 | PAKSWELL",
        ogDescription: "中国EPAL托盘制造商，为整柜出口提供热处理、质量控制、装柜及出口文件。",
        eyebrow: "中国EPAL托盘制造商 | ISPM 15支持",
        heroTitle: "中国EPAL欧标托盘制造商，服务整柜出口",
        heroCopy: "PAKSWELL在中国生产EPAL 1和EPAL 3托盘，为整柜买家提供ISPM 15热处理、质量控制、装柜及完整出口文件。",
        ...
        specsLead: "PAKSWELL生产EPAL托盘，并在采购前确认型号、生产计划、热处理、质量控制、装柜路线与目的国文件。",
        spec1Key: "尺寸",
      ...
      "zh-TW": {
        ...
        metaDescription: "PAKSWELL在中國生產EPAL 1與EPAL 3歐標棧板，為整櫃買家提供ISPM 15熱處理、品質控制、裝櫃及出口文件。",
        ogTitle: "中國 EPAL 歐標棧板 | PAKSWELL",
        ogDescription: "中國EPAL棧板製造商，為整櫃出口提供熱處理、品質控制、裝櫃及出口文件。",
        eyebrow: "中國EPAL棧板製造商 | ISPM 15支援",
        heroTitle: "中國EPAL歐標棧板製造商，服務整櫃出口",
        heroCopy: "PAKSWELL在中國生產EPAL 1與EPAL 3棧板，為整櫃買家提供ISPM 15熱處理、品質控制、裝櫃及完整出口文件。",
        ...
        specsLead: "PAKSWELL生產EPAL棧板，並在採購前確認型號、生產計畫、熱處理、品質控制、裝櫃路線與目的國文件。",
        spec1Key: "尺寸",
      ...
      vi: {
        ...
        metaDescription: "PAKSWELL sản xuất pallet EPAL 1 và EPAL 3 tại Trung Quốc cho khách hàng FCL, với xử lý nhiệt ISPM 15, kiểm soát chất lượng và chứng từ xuất khẩu.",
        ...
        eyebrow: "Nhà sản xuất pallet EPAL tại Trung Quốc | ISPM 15 HT",
        heroTitle: "Nhà sản xuất pallet EPAL Euro tại Trung Quốc cho xuất khẩu FCL",
        heroCopy: "PAKSWELL sản xuất pallet EPAL 1 và EPAL 3 tại Trung Quốc, với xử lý nhiệt ISPM 15, kiểm soát chất lượng, đóng container và chứng từ xuất khẩu rõ ràng.",
        ...
        specsLead: "PAKSWELL sản xuất pallet EPAL và xác nhận model, kế hoạch sản xuất, xử lý nhiệt, kiểm soát chất lượng, tuyến đóng hàng và chứng từ trước PO.",
        spec1Key: "Kích thước",
      ...
      ko: {
        ...
        metaDescription: "PAKSWELL은 중국에서 EPAL 1 및 EPAL 3 팔레트를 제조하며 FCL 바이어에게 ISPM 15 열처리, 품질관리 및 수출서류를 제공합니다.",
        ogTitle: "중국산 EPAL 유로 팔레트 | PAKSWELL",
        ogDescription: "FCL 수출용 EPAL 팔레트를 생산하고 열처리, 품질관리 및 수출서류를 제공하는 중국 제조업체.",
        eyebrow: "중국 EPAL 팔레트 제조업체 | ISPM 15 HT",
        heroTitle: "FCL 수출용 중국 EPAL 유로 팔레트 제조업체",
        heroCopy: "PAKSWELL은 중국에서 EPAL 1 및 EPAL 3 팔레트를 제조하고 ISPM 15 열처리, 품질관리, 컨테이너 적재 및 수출서류를 제공합니다.",
        ...
        specsLead: "PAKSWELL은 EPAL 팔레트를 제조하며 주문 전에 모델, 생산계획, 열처리, 품질관리, 적재항 및 목적지 서류를 확인합니다.",
        spec1Key: "사이즈",
      ...
      ja: {
        ...
        metaDescription: "PAKSWELLは中国でEPAL 1・EPAL 3パレットを製造し、FCLバイヤー向けにISPM 15熱処理、品質管理、輸出書類を提供します。",
        ogTitle: "中国製 EPAL ユーロパレット | PAKSWELL",
        ogDescription: "FCL輸出向けEPALパレットを生産し、熱処理、品質管理、輸出書類を提供する中国メーカー。",
        eyebrow: "中国EPALパレットメーカー | ISPM 15 HT",
        heroTitle: "FCL輸出向け中国EPALユーロパレットメーカー",
        heroCopy: "PAKSWELLは中国でEPAL 1・EPAL 3パレットを製造し、ISPM 15熱処理、品質管理、コンテナ積載、輸出書類まで一貫対応します。",
        ...
        specsLead: "PAKSWELLはEPALパレットを製造し、発注前にモデル、生産計画、熱処理、品質管理、積載港、仕向地書類を確認します。",
        spec1Key: "サイズ",

(function () {
  ...
  var COPY = {
    en: {
      ...
      stat_selected: "selected references", stat_period: "January–June", stat_fcl: "production · export · domestic", stat_privacy: "client details protected",
    ...
    "zh-CN": {
      ...
      stat_selected: "精选实景", stat_period: "1月至6月", stat_fcl: "生产 · 出口 · 国内", stat_privacy: "客户信息受保护",
    ...
    "zh-TW": {
      ...
      stat_selected: "精選實景", stat_period: "1月至6月", stat_fcl: "生產 · 出口 · 國內", stat_privacy: "客戶資訊受保護",
    ...
    th: {
      ...
      stat_selected: "ภาพคัดสรร", stat_period: "มกราคม–มิถุนายน", stat_fcl: "การผลิต · ส่งออก · ในประเทศ", stat_privacy: "ปกป้องข้อมูลลูกค้า",
    ...
    vi: {
      ...
      stat_selected: "hình ảnh tuyển chọn", stat_period: "Tháng 1–Tháng 6", stat_fcl: "sản xuất · xuất khẩu · nội địa", stat_privacy: "bảo vệ thông tin khách hàng",
    ...
    ko: {
      ...
      stat_selected: "선별된 현장 사진", stat_period: "1월–6월", stat_fcl: "생산 · 수출 · 국내", stat_privacy: "고객 정보 보호",
    ...
    ja: {
      ...
      stat_selected: "厳選事例", stat_period: "1月–6月", stat_fcl: "生産 · 輸出 · 国内", stat_privacy: "顧客情報を保護",
